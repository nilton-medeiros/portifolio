                ...
                controls=[
                    ...
                    ft.TextButton(
                        content=ft.Row(
                            controls=[
                                ft.Text(
                                    value='VER AO VIVO', theme_style=ft.TextThemeStyle.BODY_LARGE, color=ft.colors.PRIMARY),
    ...
    def build(self):
        return ft.Container(
            ...
            content=ft.Column(
                ...
                spacing=30,
                controls=[
                    ft.Text(value='Pagamento por hora',
                            theme_style=ft.TextThemeStyle.LABEL_LARGE),
                    ft.Text(
                        spans=[
                    ...
                    ft.TextButton(
                        content=ft.Row(
                            controls=[
                                ft.Text(
                                    value='QUERO ESTE', theme_style=ft.TextThemeStyle.BODY_LARGE, color=ft.colors.PRIMARY),
                                ft.Icon(name=ft.icons.ARROW_FORWARD_IOS,
                                        size=14, color=ft.colors.PRIMARY),
                            ],
                            alignment=ft.MainAxisAlignment.CENTER,
            ...
            content=ft.Stack(
                controls=[
                    ft.Column(
                        spacing=0,
                        controls=[
                            ft.Text(value=self.user,
                                    theme_style=ft.TextThemeStyle.LABEL_LARGE),
                            ft.Text(value=self.job,
                                    theme_style=ft.TextThemeStyle.BODY_MEDIUM, italic=True),
...
class MainContent(ft.UserControl):
    ...
    def build(self):
        banner = ft.Container(
            shadow=ft.BoxShadow(
                # color=ft.colors.ON_BACKGROUND,    # Este comando não está surtindo efeito, sempre fica na cor branco
                color='#2d2d3a',
            ...
            content=ft.ResponsiveRow(
                ...
                controls=[
                    ft.Container(
                        ...
                        content=ft.Column(
                            controls=[
                                ft.Text(value='Descubra meu Incrível Portifólio',
                                        theme_style=ft.TextThemeStyle.HEADLINE_LARGE),
                                ft.Text(
                                    spans=[
                                        ft.TextSpan(text='<'),
                                        ft.TextSpan(text="code", style=ft.TextStyle(
                                            color=ft.colors.PRIMARY)),
                                        ft.TextSpan(text="> "),
                                        ft.TextSpan(
                                            text="Eu desenvolvo aplicativos iOS e Android, softwares apra MacOS, Windows e Linux. Além de websites responsivos.",
                                            style=ft.TextStyle(
                                ...
                                ft.ElevatedButton(
                                    bgcolor=ft.colors.PRIMARY,
                                    content=ft.Text(
                                        value='Explore agora', color=ft.colors.BLACK, weight=ft.FontWeight.BOLD),
                                    url='',
        ...
        projects = ft.ResponsiveRow(
            ...
            controls=[
                ...
                ProjectItem(
                    ...
                    description='sistema completo de autenticação de usuárrio com suporte a recuperação de senha e cadastro de novos usuários.',
                    url='',
                    col={'xs': 12, 'md': 6, 'lg': 4},
                ),
                ProjectItem(
        ...
        testimonials = Carousel(
            controls=[
                TestimonialItem(
                    ...
                    testimonial='O trabalho do Nilton é realmente incrível, seus projetos são muitos bonitos! Nunca pensei que desse pra clonar um site inteiro apenas com Python!!!',
                ...
                TestimonialItem(
                    ...
                    job='Pentagon Boy',
                    testimonial='O trabalho do Nilton é realmente incrível, seus projetos são muitos bonitos! Nunca pensei que desse pra clonar um site inteiro apenas com Python!!!',
                    image_src='images/testimonial-default.jpg',
                ),
                TestimonialItem(
                    user='João Paulo',
                    job='Barbeiro Brutal',
                ...
                controls=[
                    ...
                    ft.Text(
                        ...
                        spans=[
                            ...
                            ft.TextSpan(
                                text='comercial@sistrom.com.br',
                                url='mailto:comercial@sistrom.com.br'
                            )
                        ],
                        theme_style=ft.TextThemeStyle.BODY_MEDIUM,
